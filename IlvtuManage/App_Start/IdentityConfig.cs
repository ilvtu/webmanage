...
namespace IlvtuManage
{
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        ...
        {
            ApplicationRoleManager roleManager = new ApplicationRoleManager(new RoleStore<ApplicationRole>(dbContext));
            ApplicationUserManager userManager = new ApplicationUserManager(new UserStore<ApplicationUser>(dbContext));

            string roleName = "Administrator";
            const string name = "ilvtu@ilvtu.net";//用户名
            const string email = "ilvtu@ilvtu.net";//邮箱
            const string password = "`12qwaszx";//密码
